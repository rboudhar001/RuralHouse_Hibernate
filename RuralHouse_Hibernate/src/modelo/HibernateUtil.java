...
public class HibernateUtil {
	...
	private static SessionFactory buildSessionFactory() {
		try {
			...
			// Crea una instancia de SessionFactory con los datos deconfiguración
			// de hibernate.cfg.xml, que debe colocarse en el subdirectorio
			// “src”
			// Si se creara la instancia de SessionFactory de la siguiente
			// manera,
			// entonces, habría que colocar el fichero en el directorio raíz del
			// proyecto
			//
			...
			// Y no tendría por qué llamarse "hibernate.cfg.xml" sino el nombre
