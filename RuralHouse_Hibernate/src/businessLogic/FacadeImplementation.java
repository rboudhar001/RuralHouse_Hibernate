...
public class FacadeImplementation implements ApplicationFacadeInterface {
	...
	public RuralHouse addRuralHouse(RuralHouse rh) {
		...
		try {
			...
			System.out.println("ERROR: FacadeImplementation:addRuralHouse : No se pudo añadir la casa rural: " + e.toString());
		}
		return rHouse;
	}
	...
	public RuralHouse removeRuralHouse(RuralHouse rh) {
		...
		try {
			...
			result_own.get(0).removeRuralHouse(rh); //METODO AÑADIDO
